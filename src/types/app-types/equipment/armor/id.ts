...
export const Arms = [
    ...
    "tindalos_band", "nightingale", "plasma_arc", "smart_band", "minuteman_armband", "sports_watch", "music_box", "schrödinger_s_box",
    ...
    "claddagh_ring", "smash_totem", "pharaoh_s_artifact", "prominence", "bloodripper"
]
