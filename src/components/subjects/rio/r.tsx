...
const r: React.FC<SubjectSkillProps> = props => {
    return (
        <>
            ...
            <br />
            短弓：莉央が指定した方向へ3本の矢を素早く発射してそれぞれ<Value skill="R" ratio={Constants.R.hankyu_first_damage} />のスキルダメージを与えて敵を押し出し、連射/正射必中のクールダウンを
            {Constants.R.hankyu_cooldown_reduction}秒減少させます。3本の矢を発射した後、スキルをもう一度使用すると追加で強力な矢を発射して<Value skill="R" ratio={Constants.R.hankyu_second_damage} />
            ...
            <br />
            和弓：莉央が集中して矢を発射し、<Value skill="R" ratio={Constants.R.daikyu_damage} />の範囲スキルダメージを与え、 
