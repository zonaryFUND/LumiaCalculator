...
const table: DamageTable = {
    ...
    skill: [
        [
            ...
            {label: "短弓W(最大ヒット)", skill: "W", value: Constants.W.hankyu_damage, multiplier: [{basic: 100 + 4 * Constants.W.multiple_hit}]},
        ],
        [
        ...
        [
            ...
            {label: "短弓E2ヒット", skill: "E", value: Constants.E.hankyu_damage, multiplier: [{basic: 200}]}
        ],
        [
        ...
        [
            ...
            {label: `短弓R1全ヒット(3)`, skill: "R", value: Constants.R.hankyu_first_damage, multiplier: [{basic: 300}]},
            {label: `短弓R2`, skill: "R", value: Constants.R.hankyu_second_damage}
        ],
        [
            {label: "和弓R", skill: "R", value: Constants.R.daikyu_damage},
            {label: "和弓R強化", skill: "R", value: Constants.R.daikyu_damage, multiplier: [{basic: Constants.R.daikyu_enhance.damage + 100}]}
        ]
    ]   
}
