...
const r: React.FC<SubjectSkillProps> = props => (
    <>
        ...
        <Damage skill="R" constants={Constants.R.first_damage.outer} {...props} />
        のスキルダメージを与え、中心部の敵には
        <Damage skill="R" constants={Constants.R.first_damage.center} {...props} />
        ...
        <Damage skill="R" constants={Constants.R.later_damage.outer} {...props} />のスキルダメージを
        {Constants.R.later_damage.amount}回与え、中心部の敵には
        <Damage skill="R" constants={Constants.R.later_damage.center} {...props} />
