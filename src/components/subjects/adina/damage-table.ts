...
const table: DamageTableGenerator = props => ({
    ...
    skill: [
        ...
        [
            ...
            {label: props.intl.formatMessage({id: "subject.adina.w-star"}), "skill": "W", value: Constants.W.star.shield, type: "shield"},
        ],
        [
            ...
            {label: props.intl.formatMessage({id: "subject.adina.e-star"}), "skill": "E", value: Constants.E.damage, multiplier: [{basic: Constants.E.star}], type: "heal"},
        ],
        [
        ...
        [
            {label: props.intl.formatMessage({id: "subject.adina.star-conjunction-heal"}), skill: "R", value: Constants.R.star_conjunction.hp, type: "heal"},
            {label: props.intl.formatMessage({id: "subject.adina.star-conjunction-heal-sum"}), skill: "R", value: Constants.R.star_conjunction.hp, type: "heal", multiplier: [{basic: Constants.E.conjunction * 100}]},
            {label: props.intl.formatMessage({id: "subject.adina.star-conjunction-sp-heal"}), skill: "R", value: Constants.R.star_conjunction.sp, type: "heal"},
            {label: props.intl.formatMessage({id: "subject.adina.star-conjunction-sp-heal-sum"}), skill: "R", value: Constants.R.star_conjunction.sp, type: "heal", multiplier: [{basic: Constants.E.conjunction * 100}]},
        ],
        [
