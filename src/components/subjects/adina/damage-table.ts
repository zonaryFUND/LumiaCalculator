...
const table: DamageTable = {
    ...
    skill: [
        ...
        [
            ...
            {label: "E(2ヒット)", "skill": "E", value: Constants.E.damage, multiplier: 200},
            {label: "E太陽追加ダメージ", "skill": "E", value: Constants.E.sun},
            {label: "E太陽追加ダメージ(2ヒット)", "skill": "E", value: Constants.E.sun, multiplier: 200},
            {label: "E星回復", "skill": "E", value: Constants.E.damage, multiplier: Constants.E.star, type: "heal"},
        ],
        [
        ...
        [
            ...
            {label: "月コンジャンクション(2ヒット)", skill: "R", value: Constants.R.moon_conjunction, multiplier: 200}
        ],
        [
            {label: "星コンジャンクション体力回復/秒", skill: "R", value: Constants.R.star_conjunction.hp, type: "heal"},
            {label: "星コンジャンクション体力回復総量", skill: "R", value: Constants.R.star_conjunction.hp, type: "heal", multiplier: Constants.E.conjunction * 100},
            {label: "星コンジャンクションスタミナ回復/秒", skill: "R", value: Constants.R.star_conjunction.sp, type: "heal"},
            {label: "星コンジャンクションスタミナ回復総量", skill: "R", value: Constants.R.star_conjunction.sp, type: "heal", multiplier: Constants.E.conjunction * 100},
        ],
        [
