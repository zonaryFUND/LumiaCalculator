...
const table: DamageTable = {
    ...
    skill: [
        ...
        [
            ...
            {label: `W糸回転固定ダメージ最大ヒット(${Constants.W.duration})秒`, skill: "W", value: Constants.W.damage, type: "true", multiplier: Constants.W.duration * 100},
        ...
        [
            ...
            {label: "R連結ライン最大固定ダメージ/秒", skill: "R", value: Constants.R.damage, multiplier: Constants.R.damage_max_multipler * 100, type: "true"},
        ],
