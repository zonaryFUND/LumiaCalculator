...
const e: React.FC<SubjectSkillProps> = props => (
    <>
        ...
        <Damage skill="E" constants={Constants.DebiE.damage} {...props} />のスキルダメージを与えます。また、
        ...
        を使用するとデビーが前方に突進して経路上の敵に<Damage skill="E" constants={Constants.DebiE.second_damage} {...props} />
