...
const table: DamageTableGenerator = props => ({
    basicAttack: [
        ...
        {label: props.intl.formatMessage({id: "subject.markus.q-additional-heal"}), skill: "Q", value: Constants.Q.damage, type: {type: "heal", target: "self"}, damageDependent: Constants.Q.heal},
        ...
        {label: props.intl.formatMessage({id: "subject.markus.q-additional-heal-max-hit"}, {value: Constants.Q.count}), skill: "Q", value: Constants.Q.damage, type: {type: "heal", target: "self"}, multiplier: Constants.Q.count * 100, damageDependent: Constants.Q.heal},
