...
const r: React.FC<SubjectSkillProps> = props => {
    return (
        <>
            ...
            {Constants.HumanR.movement_speed[props.skillLevel]}と防御力が{Constants.HumanR.defense[props.skillLevel]}
            増加し、バイクスキルを使用できます。<br />
            バイクに搭乗するとエンジンがかかって、しばらくの間移動速度が変化します。<br />
            {Constants.HumanR.ms_penalty.duration}秒間移動速度変化:{Constants.HumanR.ms_penalty.effect[props.skillLevel]}%<br />
