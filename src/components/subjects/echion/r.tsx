...
const r: React.FC<SubjectSkillProps> = props => (
    <>
        ...
        {Constants.R.damage_amp_per_vf[props.config.skillLevels.R]}％スキルのダメージ量が増加します。<br />
        <br />
        ...
        {Constants.R.area_damage_tick}秒ごとに<Damage skill="R" constants={Constants.R.area_damage} {...props} />
