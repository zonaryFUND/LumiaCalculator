...
const table: DamageTableGenerator = props => ({
    ...
    skill: [
        ...
        [
            {label: props.intl.formatMessage({id: "subject.jan.e-heal-min"}), "skill": "T", value: Constants.E.damage, type: "heal", target: "self", damageDependent: Constants.E.heal.min},
            {label: props.intl.formatMessage({id: "subject.jan.e-heal-max"}), "skill": "T", value: Constants.E.damage, type: "heal", target: "self", damageDependent: Constants.E.heal.max}
        ],
