...
const t: React.FC<SubjectSkillProps> = props => (
    <>
        イレムは他の地域に侵入すると警戒して視界が{Constants.T.vision[props.config.skillLevels.T]}増加します。同じ地域に
        {Constants.T.stay}秒間留まってその地域に慣れると、視界が増加する代わりに他の能力値が強化されます。<br />
        イレムの時：攻撃速度増加 {Constants.T.attack_speed[props.config.skillLevels.T]}％<br />
        ネコの時：防御力増加 {Constants.T.defense[props.config.skillLevels.T]}<br />
        <br />
