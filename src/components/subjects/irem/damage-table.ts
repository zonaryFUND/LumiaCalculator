...
const table: DamageTable = {
    ...
    skill: [
        [
            ...
            {label: "イレムQ(1バウンド)", skill: "Q", value: Constants.IremQ.damage, multiplier: (1 + Constants.IremQ.ratio) * 100},
            {label: "イレムQ(2バウンド)", skill: "Q", value: Constants.IremQ.damage, multiplier: (1 + Constants.IremQ.ratio * 2) * 100},
            {label: "イレムQ(3バウンド)", skill: "Q", value: Constants.IremQ.damage, multiplier: (1 + Constants.IremQ.ratio * 3) * 100},
        ],
        [{label: "イレムW", skill: "W", value: Constants.IremW.damage}],
        [
            {label: "ネコQパンチ", skill: "Q", value: Constants.CatQ.rush_damage},
            {label: `ネコQパンチ最大ヒット(${Constants.CatQ.rush.amount})`, skill: "Q", value: Constants.CatQ.rush_damage, multiplier: Constants.CatQ.rush.amount * 100}
        ],
