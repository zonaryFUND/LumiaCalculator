...
const table: DamageTableGenerator = props => ({
    ...
    skill: [
        [
            ...
            {label: props.intl.formatMessage({id: "subject.irem.irem-q-bounce"}, {value: 1}), skill: "Q", value: Constants.IremQ.damage, multiplier: (1 + Constants.IremQ.ratio) * 100},
            {label: props.intl.formatMessage({id: "subject.irem.irem-q-bounce"}, {value: 2}), skill: "Q", value: Constants.IremQ.damage, multiplier: (1 + Constants.IremQ.ratio * 2) * 100},
            {label: props.intl.formatMessage({id: "subject.irem.irem-q-bounce"}, {value: 3}), skill: "Q", value: Constants.IremQ.damage, multiplier: (1 + Constants.IremQ.ratio * 3) * 100},
        ],
        ...
        [{label: props.intl.formatMessage({id: "subject.irem.cat-r-shield"}), skill: "R", value: Constants.CatR.shield, type: {type: "shield", target: "self"}}]
    ]    
})
