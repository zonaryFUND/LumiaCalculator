...
const w: React.FC<SubjectSkillProps> = props => (
    <>
        ...
        <Damage skill="W" constants={Constants.W.damage} {...props} />のスキルダメージを与えて敵の移動速度を
        ...
        秒間移動しながら消化液を撒いて範囲内の敵に{Constants.W2.tick}秒あたり<Damage skill="W" constants={Constants.W2.damage} {...props} />
