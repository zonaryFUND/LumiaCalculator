...
const table: DamageTable = {
    ...
    skill: [
        [
            ...
            {label: "Q(T最大スタック時)", skill: "Q", value: Constants.Q.damage, multiplier: [{basic: 100 + Constants.Q.max_stack_damage}]}
        ],
        [
        ...
        [
            ...
            {label: "R空中2連撃2ヒット", skill: "R", value: Constants.R.second_damage, multiplier: [{basic: 200}]},
            {label: "R振り下ろし", skill: "R", value: Constants.R.third_damage}
        ],
        [
            {label: "T追加ダメージ", skill: "T", value: Constants.T.damage},
            {label: "E効果中T固定ダメージ転換量", skill: "T", value: Constants.T.damage, multiplier: [{basic: Constants.E.damage_conversion}], type: "true"},
