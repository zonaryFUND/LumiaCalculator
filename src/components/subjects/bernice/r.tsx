...
export const info: TooltipInfo = {
    ...
    values: ({ skillLevel, showEquation }) => ({
        ...
        1: showEquation ? Constants.R.first_damage.base[skillLevel] : Constants.R.bind,
        2: showEquation ? `${Constants.R.first_damage.attack}%` : Constants.R.second_damage,
        3: showEquation ? Constants.R.bind : `${Constants.R.spread_range}m`,
        4: showEquation ? Constants.R.second_damage.base[skillLevel] : Constants.R.max_spread,
