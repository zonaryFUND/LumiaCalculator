...
const table: DamageTableGenerator = props => ({
    ...
    skill: [
        [
            ...
            {label: props.intl.formatMessage({id: "subject.theodore.q-heal"}), skill: "Q", value: Constants.Q.heal, type: {type: "heal", target: "ally"}},
            {label: props.intl.formatMessage({id: "subject.theodore.q-screen-damage"}), skill: "Q", value: Constants.Q.screen_damage},
            {label: props.intl.formatMessage({id: "subject.theodore.q-screen-heal"}), skill: "Q", value: Constants.Q.screen_heal, type: {type: "heal", target: "any"}}
        ],
        ...
        [{label: props.intl.formatMessage({id: "subject.theodore.passive-shield"}), skill: "T", value: Constants.T.shield, type: {type: "shield", target: "self"}}]
    ]   
})
