...
const r: React.FC<SubjectSkillProps> = props => (
    <>
        ...
        {Constants.R.movement_speed[props.config.skillLevels.R]}％増加させ、強力なエネルギー波動を発射して敵に
        ...
        {Constants.R.hypercharge_duration}秒間{Constants.R.attack_speed[props.config.skillLevels.R]}％増加し、
