...
const r: React.FC<SubjectSkillProps> = props => (
    <>
        ジャッキーが{Constants.R.duration[props.config.skillLevels.R]}秒間電気ノコギリを取り出し、基本攻撃で<Damage skill="R" constants={Constants.R.damage} {...props} />
        ...
        <Damage skill="R" constants={Constants.R.finish_damage} {...props} /> ~ <Damage skill="R" constants={maxDamage} {...props} />のスキルダメージを与えます。
    </>
);
