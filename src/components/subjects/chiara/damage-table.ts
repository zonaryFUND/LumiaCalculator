...
const table: DamageTable = {
    ...
    skill: [
        [
            ...
            {label: "Q最大ヒット(5)時回復", skill: "Q", value: Constants.Q.heal, type: "heal", multiplier: [{basic: 500}]}
        ],
        [
            {label: "Wシールド最小値", skill: "W", value: Constants.W.shield, type: "shield"},
            {label: `Wシールド最大値(体力${Constants.W.max_shield_hp}％以下)`, skill: "W", value: Constants.W.shield, type: "shield", multiplier: [{basic: 100 + Constants.W.max_shield}]},
        ...
        .concat([...Array(Constants.T.max_stack + 1)].map((_, i) => (
            {label: `R審判固定ダメージ(烙印スタック${i})`, skill: "R", value: Constants.R.finish_damage, type: "true", multiplier: i == 0 ? undefined : [{basic: 100 + i * Constants.R.additional_damage_per_stack}]} as SkillValueProps)
        ))
    ]
}
