...
const table: DamageTableGenerator = props => ({
    ...
    skill: [
        ...
        [
            ...
            {label: props.intl.formatMessage({id: "subject.tia.passive-rb-heal"}), "skill": "T", value: Constants.T.rb.damage, type: "heal", target: "self", damageDependent: Constants.T.rb.heal},
