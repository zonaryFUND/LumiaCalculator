...
const e: React.FC<SubjectSkillProps> = props => (
    <>
        ...
        <Damage skill="E" constants={Constants.E.damage} {...props} />のスキルダメージを与えて自分の移動速度を{Constants.E.movement_speed}％増加させます。<br />
        スキルを再度使用したり、持続時間が終わると磁力ブラストが爆発して範囲内の敵に<Damage skill="E" constants={Constants.E.finish_damage} {...props} />のスキルダメージを与え、磁力ブラストが維持される間に与えたすべてのダメージ量の
        ...
        {Constants.E.slow.effect[props.config.skillLevels.E]}％減少します。
    </>
)
