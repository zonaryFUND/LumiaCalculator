...
const r: React.FC<SubjectSkillProps> = props => (
    <>
        ...
        <Damage skill="R" constants={Constants.R.damage} {...props} />のスキルダメージを受け、{Constants.R.hit_slow.duration}
        ...
        <Damage skill="R" constants={Constants.R.blast_damage} {...props} />のスキルダメージを与えます。ダメージ量は破壊された
