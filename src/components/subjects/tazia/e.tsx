...
const e: React.FC<SubjectSkillProps> = props => (
    <>
        ...
        を一つでも破壊した場合、タジアは到着位置で{Constants.E.shield_duration}秒間持続する<Damage skill="E" constants={Constants.E.shield} {...props} />
        のシールドを獲得し、敵に刃を振り回して<Damage skill="E" constants={Constants.E.damage} {...props} />のスキルダメージを与え、
