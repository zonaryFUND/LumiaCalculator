...
const table: DamageTableGenerator = props => ({
    ...
    skill: [
        [
            ...
            {label: props.intl.formatMessage({id: "subject.johann.q-heal"}), skill: "Q", value: Constants.Q.heal, type: "heal", target: "any"},
            {label: props.intl.formatMessage({id: "subject.johann.q-enhanced-damage"}), skill: "Q", value: Constants.Q.enhanced_damage},
            {label: props.intl.formatMessage({id: "subject.johann.q-enhanced-heal"}), skill: "Q", value: Constants.Q.enhanced_heal, target: "any"}
        ],
        [
            {label: props.intl.formatMessage({id: "subject.johann.e-finish-damage"}), skill: "E", value: Constants.E.damage},
            {label: props.intl.formatMessage({id: "subject.johann.e-enhanced-shield"}), skill: "E", value: Constants.E.shield, type: "shield", target: "any"},
        ...
        [
            ...
            {label: props.intl.formatMessage({id: "subject.johann.r-first-heal"}), skill: "R", value: Constants.R.heal, type: "heal", target: "any"},
            {label: props.intl.formatMessage({id: "subject.johann.r-heal-on-time"}), skill: "R", value: Constants.R.heal_per_sec, type: "heal", target: "any"},
            {label: props.intl.formatMessage({id: "subject.johann.r-heal-on-time-max-hit"}, {value: Constants.R.duration}), skill: "R", value: Constants.R.heal_per_sec, type: "heal", target: "any", multiplier: [{basic: Constants.R.duration * 100}]}
        ]
    ]   
})
