...
const table: DamageTableGenerator = props => ({
    ...
    skill: [
        ...
        [
            {label: props.intl.formatMessage({id: "subject.eleven.table.rheal"}), skill: "R", value: Constants.R.heal, type: {type: "heal", target: "self"}},
            {label: "R", skill: "R", value: Constants.R.damage},
            {label: props.intl.formatMessage({id: "subject.eleven.table.rmax"}, {value: maxRHit}), skill: "R", value: Constants.R.damage, multiplier: maxRHit * 100}
        ],
        [{   label: props.intl.formatMessage({id: "subject.eleven.table.theal"}), skill: "T", value: Constants.T.heal, type: {type: "heal", target: "any"}}]
    ]
})
