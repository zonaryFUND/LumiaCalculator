...
const t: React.FC<SubjectSkillProps> = props => {
    return (
        <>
            満足感：ルクは実験体のキルに関与すると自分が失った体力の{Constants.T.subject_kill[props.config.skillLevels.T]}%を回復し、ウィクラインのキルに関与した場合、自分が失った体力の
            {Constants.T.wickline_kill[props.config.skillLevels.T]}%を回復します。<br />
            <br />
