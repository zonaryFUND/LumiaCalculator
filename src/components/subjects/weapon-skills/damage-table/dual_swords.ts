...
const table: WeaponSkillTableGenerator = props => [
    ...
    {label: props.intl.formatMessage({id: "weapon-skill.dual-sword.d1-max-hit"}, {value: Constants.dual_swords.first_count}), skill: "D", value: Constants.dual_swords.first_damage, multiplier: Constants.dual_swords.first_count * 100},
