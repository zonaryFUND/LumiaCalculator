...
const table: DamageTableGenerator = props => ({
    ...
    skill: [
        [
            ...
            {label: props.intl.formatMessage({id: "subject.leni.q-heal"}), skill: "Q", value: Constants.Q.heal, type: "heal", target: "any"},
        ],
        [{label: "W", skill: "W", value: Constants.W.damage}],
        [
            {label: props.intl.formatMessage({id: "subject.leni.e-damage"}), skill: "E", value: Constants.E.damage},
            {label: props.intl.formatMessage({id: "subject.leni.e-shield"}), skill: "E", value: Constants.E.shield, type: "shield", target: "any"}
        ],
