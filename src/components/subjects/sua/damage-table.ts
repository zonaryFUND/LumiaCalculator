...
const table: DamageTableGenerator = props => ({
    ...
    skill: [
        ...
        [
            {label: props.intl.formatMessage({id: "subject.sua.w-shield"}), skill: "W", value: Constants.W.shield, type: "shield", target: "any"},
        ...
        [
            ...
            {label: props.intl.formatMessage({id: "subject.sua.e-heal-min"}), skill: "E", value: Constants.E.heal, type: "heal", target: "self"},
            {label: props.intl.formatMessage({id: "subject.sua.e-heal-max"}), skill: "E", value: Constants.E.heal, type: "heal", target: "self", multiplier: [{basic: Constants.E.heal_max_multiplier * 100}]},
        ],
        [
        ...
        [
            {label: props.intl.formatMessage({id: "subject.sua.rw-shield"}), skill: "R", value: Constants.RW.shield, type: "shield", target: "any"},
        ...
        [
            ...
            {label: props.intl.formatMessage({id: "subject.sua.re-heal-min"}), skill: "R", value: Constants.RE.heal, type: "heal", target: "self"},
            {label: props.intl.formatMessage({id: "subject.sua.re-heal-max"}), skill: "R", value: Constants.RE.heal, type: "heal", target: "self", multiplier: [{basic: Constants.RE.heal_max_multiplier * 100}]},
        ]
    ]   
})
