...
const e: React.FC<SubjectSkillProps> = props => (
    <>
        スアが武器をランスに変えます。その後、前方に突進して始めて的中した敵に<Damage skill="E" constants={Constants.E.damage} {...props} />
        のスキルダメージを与えて{Constants.E.slow.duration}秒間移動速度を{Constants.E.slow.effect}％減少させます。<br />
        栞が残った状態の敵には<Damage skill="E" constants={Constants.E.bookmark_damage} {...props} />のスキルダメージを与えて空中に浮かせます。<br />
        スアはドン・キホーテを的中させた場合、失った体力に比例して
        <Damage skill="E" constants={Constants.E.heal} {...props}/> ~ <Damage skill="E" constants={healMax} {...props} />
        の体力を回復します。<br />
