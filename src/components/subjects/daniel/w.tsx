...
const w: React.FC<SubjectSkillProps> = props => (
    <>
        ...
        ダニエルは刻印が付与された敵の周辺{Constants.W.vision_range}mの視界を獲得して、{Constants.W.movement_speed_penalty.duration}
        秒間移動速度が{Constants.W.movement_speed_penalty.effect}％減少します。<br />
        刻印を付与された敵はダニエルに攻撃されるまで視界が{Constants.W.vision_decrease}減少し、{Constants.W.duration}
        秒間ダニエルが与えたダメージ量の{Constants.W.stored_damage[props.config.skillLevels.W]}％を保存します。<br />
        ...
        <Damage skill="W" constants={Constants.W.damage} {...props} />のスキルダメージを与え、
