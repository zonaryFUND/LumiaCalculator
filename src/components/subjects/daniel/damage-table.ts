...
const table: DamageTable = {
    ...
    skill: [
        ...
        [
            ...
            {label: `R潜入中全ヒット(${Constants.R.damage_count})`, skill: "R", value: Constants.R.damage, multiplier: [{basic: Constants.R.damage_count * 100}]},
            {label: "R最終最小", skill: "R", value: Constants.R.finish_damage},
            {label: "R最終最大", skill: "R", value: Constants.R.finish_damage, multiplier: [{basic: Constants.R.finish_multiplier_max}]}
        ]
    ]   
}
