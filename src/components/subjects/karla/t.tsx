...
const t: React.FC<SubjectSkillProps> = props => (
    <>
        ...
        <br />
        カーラは{Constants.T.charge_time[props.config.skillLevels.T]}秒間装填ゲージをチャージし、チャージされなかった基本攻撃は装填ゲージを一部消耗して
        <Damage skill="T" constants={Constants.T.damage} {...props} />のスキルダメージを与えます。チャージが完了した基本攻撃は装填ゲージをすべて消耗し、
        <Damage skill="T" constants={Constants.T.full_charge_damage} {...props} />のスキルダメージを与えて
