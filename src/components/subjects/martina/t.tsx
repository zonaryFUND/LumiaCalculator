...
const t: React.FC<SubjectSkillProps> = props => {
    return (
        <>
            ...
            <br />
            マルティナの4K UHDカメラは基本攻撃をするたび<Damage skill="T" constants={Constants.T.damage} {...props} />のダメージを与えて電力を消耗し、充電が完了するまで基本攻撃ができません。充電時間は
            ...
            <Damage skill="T" constants={Constants.T.mark_damage} {...props} />のスキルダメージを与えます。<br />
            <br />
            <span className={martina.broadcast}>[放送中]</span><br />
            基本攻撃が<Damage skill="T" constants={Constants.T.broadcasting_damage} {...props} />のダメージを与え、刻印が付与された敵にスキルが的中すると刻印を消耗して
            <Damage skill="T" constants={Constants.T.broadcasting_mark_damage} {...props} />のスキルダメージを与えます。
        </>
    );
}
...
export const values: ValuesProps = {
    parameters: [
        ...
        {title: "[放送中]刻印ダメージ量", values: Constants.T.broadcasting_mark_damage.base},
