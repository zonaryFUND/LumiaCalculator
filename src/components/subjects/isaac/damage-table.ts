...
const table: DamageTableGenerator = props => ({
    ...
    skill: [
        ...
        [
            ...
            {label: props.intl.formatMessage({id: "subject.isaac.passive-heal"}), "skill": "T", value: Constants.T.damage, type: {type: "heal", target: "self"}, damageDependent: Constants.T.heal},
        ],
    ]
})
