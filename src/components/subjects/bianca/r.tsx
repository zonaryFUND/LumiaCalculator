...
const r: React.FC<SubjectSkillProps> = props => (
    <>
        ...
        のスキルダメージを与えて{Constants.R.slow.duration}秒間移動速度を{Constants.R.slow.effect}％減少させます。ビアンカは魔法陣の上にいると、ダメージ吸血が{Constants.R.omnisyphon_amp[props.config.skillLevels.R]}％増加します。<br />
