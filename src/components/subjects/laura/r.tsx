...
const r: React.FC<SubjectSkillProps> = props => {
    return (
        <>
            ...
            <Damage skill="R" constants={Constants.R.first_damage} {...props} />のスキルダメージを与えます。突進中に初めて衝突した敵はラウラによって到着地点まで引きずられていきます。<br />
            阻止不可状態は鞭が壁に衝突しなかったり、ラウラの突進が終わると解除されます。<br />
            ラウラは突進後、目標地点に到着または壁にぶつかると後ろに大きく回って着地します。この時、周りに<Damage skill="R" constants={Constants.R.second_damage} {...props} />のスキルダメージを与えて
