...
const table: DamageTableGenerator = props => ({
    ...
    skill: [
        ...
        [
            ...
            {label: props.intl.formatMessage({id: "subject.alonso.w-wave-max-hit"}, {value: wMax}), skill: "W", value: Constants.W.damage, multiplier: wMax * 100},
        ...
        [
            ...
            {label: props.intl.formatMessage({id: "subject.alonso.r-damage-max-hit"}, {value: rMax}), skill: "R", value: Constants.R.damage_on_time, multiplier: rMax * 100},
            {label: props.intl.formatMessage({id: "subject.alonso.r-heal-per-tick"}, {value: Constants.R.tick}), skill: "R", value: Constants.R.heal, type: {type: "heal", target: "self"}},
            {label: props.intl.formatMessage({id: "subject.alonso.r-heal-max"}, {value: rMax}), skill: "R", value: Constants.R.heal, multiplier: rMax * 100, type: {type: "heal", target: "self"}},
        ...
        [{label: props.intl.formatMessage({id: "subject.alonso.passive-heal"}), skill: "T", value: Constants.T.heal, type: {type: "heal", target: "self"}}]
    ]
})
