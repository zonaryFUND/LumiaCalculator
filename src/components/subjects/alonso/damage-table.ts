...
const table: DamageTable = {
    ...
    skill: [
        ...
        [
            ...
            {label: `W波動最大ヒット(${wMax})`, skill: "W", value: Constants.W.damage, multiplier: wMax * 100},
        ...
        [
            ...
            {label: `R継続最大ヒット(${rMax})`, skill: "R", value: Constants.R.damage_on_time, multiplier: rMax * 100},
            {label: "R回復/0.5秒", skill: "R", value: Constants.R.heal},
            {label: `R回復最大ヒット(${rMax})`, skill: "R", value: Constants.R.heal, multiplier: rMax * 100},
