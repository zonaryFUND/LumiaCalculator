...
const t: React.FC<SubjectSkillProps> = props => (
    <>
        <span className={style.emphasis}>発掘統裁</span>：アルダが生命の木、隕石の採取を始めると
        自分の周りの領域内の敵を沈黙させるエリアを生成します。生成されたエリアは採取中持続されます。<br />
        <br />
        <span className={style.emphasis}>考古学的分析</span>：アルダが使用する遺物が敵にダメージを与えると
        アルダは<span className={style.emphasis}>古代の精髄</span>を獲得します。
