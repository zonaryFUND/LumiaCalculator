...
const e: React.FC<SubjectSkillProps> = props => {
    return (
        <>
            エヴァが{Constants.E.movement_speed.duration}秒間移動速度が{Constants.E.movement_speed.effect[props.config.skillLevels.E]}
            ...
            {Constants.E.vflight_duration}秒間VFライトを発射して<Damage skill="E" constants={Constants.E.damage} {...props} />のスキルダメージを与えます。<br />
