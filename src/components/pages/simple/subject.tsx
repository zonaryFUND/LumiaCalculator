...
import Selection from "./number-selection";
import EquipmentSlot from "../../subject/equipment-slot";
...
const subject: React.FC<Props> = props => {
    ...
    return (
        <div className={`${index.row} ${style.subject}`}>
            <header>
                <h1>実験体</h1>
            </header>
            <div className={style.config}>
                <div className={style.top}>
                    <img src={Images.subject[props.subject[0]]} onClick={toggleSelectingSubject} />
                    <div>
